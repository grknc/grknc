...
# Wilson Lower 1-3 negatif, 4 ve 5 arasında pozitif
...
# Out[95]: 0.5693094295142663

wilson_lower_bound(5500,4500)
# Out[96]: 0.5402319557715324
...
# Önümüzde bir puan hesabı varsa
# 5 yıldızlı bir rating varsa Bayesian Average

# Kullanıcı davranışlarına dair ağırlıklı hesap yapılabilir.
# Sıralama yöntemleri
# Kişisel matematik çözüm sıralama
# Ratelemek
# Biasian Average
# Hibrit Yaklaşımı benimseyerek çözmek
